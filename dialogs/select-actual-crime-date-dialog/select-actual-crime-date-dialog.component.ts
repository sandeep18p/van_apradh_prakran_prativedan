...
@Component({
  standalone: true,
  selector: 'app-select-actual-crime-date-dialog',
  templateUrl: './select-actual-crime-date-dialog.component.html',
  styleUrls: ['./select-actual-crime-date-dialog.component.scss'],
  imports: [
    IonDatetime, FormsModule, IonButton, IonGrid, IonCol, IonRow]
})
export class SelectActualCrimeDateDialogComponent implements OnInit {
  ...
  onSelectDate() {
    ...
    this.sharedService.setSelectedActualCrimDate(this.selectedDate);
